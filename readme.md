...
1. Clone the repository:
   ```bash
   git clone https://github.com/Preetham-jayam/Code-it-searchEngine.git
   ```
...
### Question Page 
<img src="question.png" alt="Question search" width="500"/>

## Contact

If you have any questions, feel free to reach out:

- **Email**: [preethamjayam2004@gmail.com](mailto:preethamjayam2004@gmail.com)
- **LinkedIn**: [Preetham Jayam](https://www.linkedin.com/in/naga-preetham-jayam-941998229/)
- **GitHub**: [Preetham_jayam](https://github.com/Preetham_jayam)
